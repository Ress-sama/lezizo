...
public static class AnimatorExtensions
{
    ...
    public static StateMachineBehaviorListener GetStateMachineBehaviorListener(this Animator animator,
        AnimationState animationState)
    {
        StateMachineBehaviorListener[] machineBehaviorListeners =
            animator.GetBehaviours<StateMachineBehaviorListener>();
        foreach (var machineBehaviorListener in machineBehaviorListeners)
        {
            if (machineBehaviorListener.AnimationState == animationState)
            {
                return machineBehaviorListener;
            }
        }
